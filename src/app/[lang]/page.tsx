...
import { TOOL_META, type ToolKey } from "@/lib/tool-meta";
...
type HomeMsgs = Record<Lang, { heroTitle: string; heroSub: string; footer1: string; footer2: string }>;

const homeMsgs: HomeMsgs = {
  pt: { heroTitle: "Ferramentas Online Grátis", heroSub: "Simples, gratuito e privado. Todas as ferramentas rodam no seu navegador — sem upload para servidores, sem cadastro.", footer1: "Desenvolvido por", footer2: "— Ferramentas gratuitas, sem amarras." },
  tr: { heroTitle: "Ücretsiz Çevrimiçi Araçlar", heroSub: "Basit, ücretsiz ve gizli. Tüm araçlar tarayıcınızda çalışır — sunucuya yükleme yok, kayıt gerekmez.", footer1: "Tarafından geliştirildi", footer2: "— Ücretsiz araçlar, hiçbir koşul yok." },
  th: { heroTitle: "เครื่องมือออนไลน์ฟรี", heroSub: "เรียบง่าย ฟรี และเป็นส่วนตัว ทุกเครื่องมือทำงานในเบราว์เซอร์ของคุณ — ไม่มีการอัปโหลดไปยังเซิร์ฟเวอร์ ไม่ต้องสมัคร", footer1: "พัฒนาโดย", footer2: "— เครื่องมือฟรี ไม่มีเงื่อนไข" },
  vn: { heroTitle: "Công Cụ Online Miễn Phí", heroSub: "Đơn giản, miễn phí và riêng tư. Tất cả công cụ chạy trong trình duyệt — không tải lên máy chủ, không cần đăng ký.", footer1: "Phát triển bởi", footer2: "— Công cụ miễn phí, không ràng buộc." },
  en: { heroTitle: "Free Online Tools", heroSub: "Simple, free, and private. All tools run in your browser — no file uploads to servers, no sign-up required.", footer1: "Powered by", footer2: "— Free tools, no strings attached." },
};
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {tools.map((tool) => {
          const tm = TOOL_META[lang][tool.key as ToolKey];
          return (
