...
function IconPdfToWord() { return <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12"><rect x="6" y="4" width="36" height="40" rx="3" fill="#EF4444" /><text x="24" y="30" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold">PDF</text><path d="M30 16l-6 0l0 16" stroke="#3B82F6" strokeWidth="2" fill="none" /><text x="30" y="18" fill="#3B82F6" fontSize="10" fontWeight="bold">W</text></svg>; }
function IconCompress() { return <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12"><rect x="6" y="4" width="36" height="40" rx="3" fill="#EF4444" /><text x="24" y="30" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold">PDF</text><path d="M30 22l-6 0m0 0l0-10m0 10l4-4m-4 4l-4-4" stroke="#16A34A" strokeWidth="2" fill="none" /></svg>; }
function IconMerge() { return <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12"><rect x="4" y="4" width="36" height="40" rx="3" fill="#EF4444" opacity="0.7" /><text x="22" y="30" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold">1</text><rect x="10" y="8" width="36" height="40" rx="3" fill="#EF4444" /><text x="28" y="34" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold">+</text></svg>; }
