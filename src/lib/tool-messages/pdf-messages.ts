...
export const pdfPt = {
  ...
  tools: {
    pdfToWord: {
      ...
      button: "Converter para Word", processing: "Convertendo para Word...", success: "Conversão concluída!",
    ...
    compress: {
      ...
      button: "Comprimir PDF", processing: "Comprimindo...", success: "Compressão concluída!",
      dragText: "Arraste e solte o PDF aqui", orText: "ou", browseText: "Procurar arquivo", maxSize: "Máx. 25MB",
...
export const pdfEn = {
  ...
  tools: {
    pdfToWord: {
      ...
      button: "Choose PDF File", convertLabel: "Convert to Word", processing: "Converting...", success: "Conversion complete!",
      dragText: "Drag and drop PDF here", orText: "or", browseText: "Browse files", maxSize: "Max 25MB",
    },
    compress: {
      title: "Compress PDF",
      description: "Reduce PDF file size while maintaining quality.",
      button: "Choose PDF File", convertLabel: "Compress PDF", processing: "Compressing...", success: "Compression complete!",
      dragText: "Drag and drop PDF here", orText: "or", browseText: "Browse files", maxSize: "Max 25MB",
    ...
    merge: {
      ...
      button: "Choose PDF Files", convertLabel: "Merge PDFs", processing: "Merging...", success: "Merge complete!",
